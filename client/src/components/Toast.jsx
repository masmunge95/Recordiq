...
const Toast = ({ message, type = 'info', onClose, duration = 4000 }) => {
    ...
    const typeStyles = {
        success: {
            ...
            bgDark: 'bg-green-900/30 border-green-700',
        ...
        error: {
            ...
            bgDark: 'bg-red-900/30 border-red-700',
        ...
        warning: {
            ...
            bgDark: 'bg-amber-900/30 border-amber-700',
        ...
        info: {
            ...
            bgDark: 'bg-blue-900/30 border-blue-700',
